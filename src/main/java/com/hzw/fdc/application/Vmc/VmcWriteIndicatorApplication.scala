...
import com.hzw.fdc.controller.Vmc.VmcWriteIndicatorController
 ...
 * @description VmcWriteIndicatorApplication
 */
object VmcWriteIndicatorApplication extends App with TApplication {
  ...
  start({
    val controller = new VmcWriteIndicatorController
    controller.execute()
  }, jobName = VmcConstants.VmcWriteIndicatorJob)
